...
function fun1() {
 ...
 if ((b1 == 'x' || b1 == 'X') && (b2 == 'x' || b2 == 'X') && (b3 == 'x' || b3 == 'X')) {
   ...
   document.getElementById('print').innerHTML = "<b>WINNER: </b> Player X";
   ...
   document.getElementById("b8").disabled = true;
   document.getElementById("b9").disabled = true;
   document.getElementById('print').innerHTML = "<b>WINNER: </b> Player 0";
 ...
 (b7 == 'X' || b7 == '0') && (b8 == 'X' ||b8 == '0') && (b9 == 'X' || b9 == '0')) {
   document.getElementById('print').innerHTML = "<b>RESULT: </b> Match Tie";
   window.alert('Match Tie');
 }
 else {
   if (flag == 1) {
     document.getElementById('print').innerHTML = "<b> TURN: </b> Player X";
   }
   else {
     document.getElementById('print').innerHTML = "<b> TURN: </b> Player 0";
   }
 }
}
function fun2() {
